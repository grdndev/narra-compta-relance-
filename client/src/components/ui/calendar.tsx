...
function CalendarDayButton({
  ...
  // Helper to check if day is outside
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isOutside && "text-muted-foreground opacity-50 bg-transparent hover:bg-transparent aria-selected:bg-transparent aria-selected:text-muted-foreground",
        defaultClassNames.day,
        className
      )}
      {...props}
