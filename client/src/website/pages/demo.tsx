      ...
      <div className="flex-1 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 pt-24">
        <div className="w-full max-w-7xl">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden grid lg:grid-cols-2 min-h-[700px]">
            ...
            {/* Right Panel: Calendly Calendar */}
            <div className="p-0 flex items-center justify-center bg-white h-full min-h-[700px]">
              {/* Calendly Inline Widget */}
              <div
                className="calendly-inline-widget w-full h-full min-h-[700px]"
                data-url="https://calendly.com/kirane-naraa/30min"
